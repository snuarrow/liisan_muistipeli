...
/**
 * Logiikan käyttöluokka, joka toimii kommunikaatiorajapintana graafiselle käyttöliittymälle, antaa korteille liikettä ja peliä aloittaessa luo uudet kortit.
 */
